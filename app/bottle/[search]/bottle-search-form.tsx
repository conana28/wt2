...
export type BottleSearchValues = z.infer<typeof BottleSearchSchema>;
type Props = {
  setBtls: (btls: any) => void;
  setSearchFields: (btls: any) => void;
};

export function BottleSearchForm({ setBtls, setSearchFields }: Props) {
